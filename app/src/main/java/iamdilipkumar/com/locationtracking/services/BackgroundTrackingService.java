...
public class BackgroundTrackingService extends Service {
    ...
    private static final int LOCATION_INTERVAL = 1000; // Change this to 10000
    private static final float LOCATION_DISTANCE = 10f; // Change this to 0 if its not working
